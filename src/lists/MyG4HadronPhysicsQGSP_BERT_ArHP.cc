...
// -- edepsim includes
#include "lists/MyG4HadronPhysicsQGSP_BERT_ArHP.hh"
#include "lists/MyG4NeutronPHPBuilder.hh"
...
// Luis' stuff to append INCLXX for neutrons
...
MyG4HadronPhysicsQGSP_BERT_ArHP::Neutron()
{
  ...
  // We change this, no BERTINI for neutrons...
  /*
